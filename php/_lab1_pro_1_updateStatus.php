...
// log();
//  find the product serial number from product table
...
$sql3 = "SELECT * FROM product WHERE p_sn = '$pSn'";
...
if($qr3){
    ...
    //  insert the product detail to the repair table
    $sql2 = "INSERT INTO repair (p_sn, p_model, p_name, floor, lab, desk, rc_address, p_s_dttm, p_r_dttm, dttm, ip)
            VALUES('$pSn', '$p_model', '$p_name', '$floor', '$lab', '$desk', '$address', '$s_dttm', '$r_dttm', '$dttm', '$ip') ";
    $qr2 = mysqli_query($conn, $sql2);

    if($qr2){
        //  update the status of the product table 
